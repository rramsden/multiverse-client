...
namespace Multiverse.Utility.Stream
{
	...
	public class PacketWriter
	{
		...
		private static bool m_fixedsize = true;

		public static PacketWriter CreateInstance()
		{
			return CreateInstance(32, true);
		}

		public static PacketWriter CreateInstance(int capacity, bool fixedsize)
		{
		...
		public byte[] ToArray()
		{
			...
			{
				ushort bSize = (ushort)m_Stream.Length;
